...
class Net(nn.Module):
    ...
    def forward(self, img):
        ...
        grad_orientation0 = (torch.atan2(grad_y_r+grad_y_g+grad_y_b, grad_x_r+grad_x_g+grad_x_b) * (180.0/3.14159))+180
        grad_orientation =  torch.round( grad_orientation0 / 45.0 ) * 45.0
        ...
        grad_orientation = grad_orientation.squeeze()
        thin_edges = thin_edges.squeeze()
        thresholded = thresholded.squeeze()
        early_threshold = early_threshold.squeeze()
